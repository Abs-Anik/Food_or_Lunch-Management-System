                            ...
                            <div class="row mg-b-25">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <select name="designation_id" id="designation_id" class="form-control @error('designation_id') is-invalid @enderror w-100 select-input-field-two">
                                        ...
                                        <option value="{{ $designation->id }}" {{ $designation->id == $admin->designation_id ? "selected" : "" }}>{{ $designation->designation }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <select class="roll_select form-control" id="roles" name="roles[]" multiple>
