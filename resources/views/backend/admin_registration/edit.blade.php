            ...
            <div class="col-md-12 mt-5">
                <div class="card pd-20 pd-sm-40">
                    <div class="d-sm-flex justify-content-between align-items-center mb-3">
                        <h4 class="header-title mb-0 p-4">Edit Admin</h4>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="row mg-b-25">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input id="enrollment" class="form-control @error('enrollment') is-invalid @enderror" type="enrollment" name="enrollment" value="{{ $admin->enrollment }}" placeholder="Enter User enrollment" data-parsley-error-message="Please give user enrollment" required autocomplete="enrollment" autofocus>
                                    @error('enrollment')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input id="designation" class="form-control @error('designation') is-invalid @enderror" type="designation" name="designation" value="{{ $admin->designation }}" placeholder="Enter User designation" data-parsley-error-message="Please give user designation" required autocomplete="designation" autofocus>
                                    @error('designation')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                    </div>
